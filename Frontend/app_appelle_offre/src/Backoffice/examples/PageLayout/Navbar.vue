...
<script>
import downArrWhite from "@/Backoffice/assets/img/down-arrow-white.svg";
import downArrBlack from "@/Backoffice/assets/img/down-arrow-dark.svg";
